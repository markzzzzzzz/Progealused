...
function requestListener(req, res) {
    ...
    html += "<form><input name='otsi' /><button>Filtreeri</button></form><br>"
    html += "<form><input name='lisa' /><button>Lisa uus</button></form><br>"
    html += "<form><input name='kustuta' /><button>Kustuta</button></form><br>"
